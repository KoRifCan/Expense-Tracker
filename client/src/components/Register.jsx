  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        className="w-full bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm text-gray-700 dark:text-gray-200 p-3 rounded-2xl border border-gray-200 dark:border-gray-600 hover:bg-white dark:hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center justify-center gap-3 shadow-sm"
      >
        {googleLoading ? (
        ...
        <span className="font-medium">{googleLoading ? 'Memproses...' : 'Daftar dengan Google'}</span>
      </button>
    </div>
  );
}
