        ...
        <form onSubmit={handleLinkAccount}>
          <div className="relative mb-4">
            <input
              ...
              required
            />
            <button type="button" onMouseDown={(e) => { e.preventDefault(); setShowPass(s => !s); setTimeout(() => passwordRef.current?.focus(), 0); }} className="absolute right-3 top-3 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
              {showPass ? (
